...
<body>
  ...
  if (isset($_FILES['video'])) {
    ...
    $conn = mysqli_connect('localhost', 'root', '', 'all_codes');
    $query = "INSERT INTO videos (name, type, size, file, video_name, description, account_holder_name, account_holder_image) VALUES ('$name', '$type', '$user_id', 'upload-long-vidios/uploads/$new_name', '$video_name', '$description', '$account_holder_name', 'uploaded_img/$account_holder_image')";
